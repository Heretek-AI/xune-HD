package com.heretek.xunehd.net

import android.content.Context
import com.heretek.xunehd.data.db.ArtistImageEntity
...
class ArtistImageService(
    ...
    @Volatile
    var settingsSnapshot: com.heretek.xunehd.data.repo.XuneSettings? = null
    ...
    companion object {
        ...
        private const val USER_AGENT = "XuneHD/0.1 (android; sister-app to not-zune)"
    }
}
