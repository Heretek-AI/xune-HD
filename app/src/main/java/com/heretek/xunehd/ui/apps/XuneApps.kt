...
fun buildAppRegistry(): List<XuneMiniApp> = listOf(
    ...
    XuneMiniApp("hearts", "hearts", "games", { com.heretek.xunehd.ui.apps.games.HeartsApp() }),
    XuneMiniApp("spades", "spades", "games", { com.heretek.xunehd.ui.apps.games.SpadesApp() }),
    XuneMiniApp("checkers", "checkers", "games", { com.heretek.xunehd.ui.apps.games.CheckersApp() }),
    XuneMiniApp("chess", "chess", "games", { com.heretek.xunehd.ui.apps.games.ChessApp() }),
    XuneMiniApp("texasholdem", "texas hold 'em", "games", { com.heretek.xunehd.ui.apps.games.TexasHoldemApp() }),
