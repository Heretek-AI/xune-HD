        ...
        AnimatedVisibility(
            ...
            Column(Modifier.fillMaxSize()) {
                ...
                Row(
                    Modifier
                        .fillMaxWidth()
                        .padding(start = XuneTokens.EDGE.dp, top = 8.dp),
                ...
                Row(
                    ...
                    Column(Modifier.padding(start = 14.dp)) {
                        ...
                        EdgeCropText(
                            ...
                            modifier = Modifier.clickable {
                                poke()
                                graph.nav.push(XuneDestination.Artist(current.artistId))
                            },
                        )
                        EdgeCropText(
                            text = current.album,
                ...
                Row(
                    Modifier
                        .fillMaxWidth()
                        .padding(horizontal = XuneTokens.EDGE.dp, vertical = 14.dp),
...
private fun TransportOverlay(
    ...
    val controller = LocalXuneGraph.current.controller
    val colors = LocalXuneColors.current
