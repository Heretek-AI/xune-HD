package com.heretek.xunehd.data.official
 ...
 * non-null, names the Xune-HD mini-app that re-implements it canonically.
 */
...
object OfficialCatalog {
    ...
    val all: List<OfficialApp> = listOf(
        ...
        OfficialApp("Checkers", "Checkers.exe", GAMES, "Classic Checkers in a park setting."),
        OfficialApp("Chess", "Chess.exe", GAMES, "Classic Chess against your Zune HD or a friend."),
        ...
        OfficialApp("Hearts", "Hearts.exe", GAMES, "Classic card game."),
        ...
        OfficialApp("Spades", "Spades.exe", GAMES, "Fast-paced classic card game."),
