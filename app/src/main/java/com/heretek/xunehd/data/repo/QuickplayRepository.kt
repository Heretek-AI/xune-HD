...
import com.heretek.xunehd.data.db.HistoryEntity
import com.heretek.xunehd.data.db.PinEntity
import com.heretek.xunehd.data.db.RatingEntity
...
class QuickplayRepository(private val db: XuneDatabase) {
