package com.heretek.xunehd.data.scan

import android.content.ContentUris
import android.content.Context
import android.net.Uri
import android.provider.MediaStore
import com.heretek.xunehd.data.db.TrackEntity
...
fun TrackEntity.toModel(): com.heretek.xunehd.data.model.Track =
    com.heretek.xunehd.data.model.Track(
        mediaId = mediaId,
        title = title,
        artist = artist,
        artistId = artistId,
