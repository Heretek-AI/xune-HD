...
import com.heretek.xunehd.data.db.AlarmEntity
import com.heretek.xunehd.data.db.AppointmentEntity
...
class NotesRepository(private val db: XuneDatabase) {
...
class CalendarRepository(private val db: XuneDatabase) {
...
class AlarmRepository(private val db: XuneDatabase) {
...
class RadioRepository(private val db: XuneDatabase) {
...
class PodcastRepository(private val db: XuneDatabase) {
...
class GameRepository(private val db: XuneDatabase) {
