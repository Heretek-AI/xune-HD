...
- **MusicIn2001** (https://github.com/BillyOutlast/MusicIn2001) — Research-Only
  License. Used exclusively as a behavioral specification (features, gesture
  set, EQ/sync model). No source code, assets, or text from MusicIn2001 are
  included in this repository.

## Fonts
- **Selawik** — Copyright 2015 Microsoft Corporation, licensed under the SIL
  Open Font License 1.1 (see docs/OFL-Selawik.txt). Selawik is a trademark of
  Microsoft Corporation; it is redistributed under the OFL as permitted.
...
- ZuneRedux/zune-hd-apps — original Zune HD app archive, design reference only.
- spidersandmoths/ZuneArtistImages and zuneupdate.com — the artist-background
  concept; no endpoints or data are hardcoded (user-configured).
